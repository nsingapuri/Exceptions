...
/**
 * EndOfFileException: FileException for when EOF is found while trying to read from a File
 **/
class EndOfFileException extends FileException
{
     ...
     **/
    public function __construct($fileName, $message='EOF', $code=0, Exception $previous=null)
    {
